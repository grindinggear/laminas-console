...
class DefaultRouteMatcherTest extends TestCase
{
     ...
     */
    public function testMatching(string $routeDefinition, array $arguments = [], array $params = null): void
    {
    ...
    public function testCannotMatchWithEmptyMandatoryParam(): void
    {
        $arguments = ['--foo='];
     ...
     */
    public function testParamsCanBeValidated(
        string $routeDefinition,
        array $validators,
        array $arguments,
        bool $shouldMatch
     ...
     */
    public function testParamsCanBeFiltered(
        string $routeDefinition,
        array $filters,
        array $arguments,
        array $params
